...
export default function CategoryView({ category }: CategoryViewProps) {
  return (
    <CategoryProvider category={category}>
      ...
      <CategoryInfo />
      <div className="page-width grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
        <Area
          ...
          coreComponents={[
            {
              component: {
                default: (
                  <div className="flex justify-between items-center gap-4 border-b border-divider pb-4 mb-8">
