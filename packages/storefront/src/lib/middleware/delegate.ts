 ...
 */
export function getDelegateManager(request: StorefrontRequest) {
 ...
 */
export function hasDelegate(id: string, request: StorefrontRequest): boolean {
...
export function getDelegates(request: StorefrontRequest): Record<string, any> {
