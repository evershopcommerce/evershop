...
export const DefaultPaginationRenderer: React.FC<{
  ...
  return (
    <div className={`products-pagination ${className}`}>
      {showInfo && (
        <div className="pagination-info text-center text-textSubdued mb-4">
          {getDisplayText()}
        </div>
      )}
...
export const CompactPaginationRenderer: React.FC<{
  ...
  return (
    ...
    >
      <div className="pagination-info text-sm text-textSubdued">
      ...
      <div className="pagination-controls flex items-center space-x-2">
        <button
          ...
          className="px-3 py-1 text-sm border border-border rounded hover:bg-surfaceSubdued disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Previous
        </button>
...
export const InputPaginationRenderer: React.FC<{
  ...
  return (
    <div className={`input-pagination ${className}`}>
      <div className="text-center text-sm text-textSubdued mb-4">
        {getDisplayText()}
      </div>
      ...
      <div className="flex items-center justify-center space-x-4">
        <button
          onClick={goToFirst}
          disabled={!hasPrev || isLoading}
          className="px-2 py-1 text-sm border border-border rounded hover:bg-surfaceSubdued disabled:opacity-50"
        >
          First
        </button>
        ...
        <button
          onClick={goToPrev}
          disabled={!hasPrev || isLoading}
          className="px-3 py-1 text-sm border border-border rounded hover:bg-surfaceSubdued disabled:opacity-50"
        >
          ←
        </button>
        ...
        >
          ...
          <button
            type="submit"
            className="px-2 py-1 text-sm bg-primary text-white rounded hover:bg-primaryHover disabled:opacity-50"
            disabled={isLoading}
          >
            Go
          </button>
