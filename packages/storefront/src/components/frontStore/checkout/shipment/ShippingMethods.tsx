...
import { CustomerAddressGraphql } from '@storefront/core/types/customerAddress';
  ...
  return (
    <div className="shipping-method-skeleton">
      {[1, 2, 3, 4].map((index) => (
        <div
          key={index}
          className="border border-divider rounded-lg p-4 mb-3 animate-pulse"
        >
      ...
      {isLoading ? (
        ...
        <>
          <div className="shipping-methods-list">
            {methods?.length === 0 ? (
              <div className="text-textSubdued text-center py-8">
                <input
                  type="hidden"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <input
                        ...
                        className="w-4 h-4 text-accent border-border focus:ring-accent disabled:opacity-50"
                      />
                      <div>
                        <div className="font-normal text-primary flex items-center">
                          <a
                            href="#"
                            onClick={(e) => {
                              e.preventDefault();
                        ...
                        {method.description && (
                          <div className="text-sm text-textSubdued mt-1">
                      ...
                      {method.cost ? (
                        <>
                          {method.cost.value > 0 ? (
                            ...
                            <>
                              <div className="text-sm text-textSubdued line-through">
                                {method.cost.text}
                              </div>
