...
describe('test getMiddlewaresByRoute', () => {
  const productMiddleweres = Handler.getMiddlewareByRoute({ id: 'product', isAdmin: false });
  ...
  const productEditMiddleweres = Handler.getMiddlewareByRoute({ id: 'productEdit', isAdmin: true });
