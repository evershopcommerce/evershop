...
function Current({ image }) {
  ...
  return (
    <div id="product-current-image" style={{ minHeight: height, background: '#f6f6f6' }} className="product-image product-single-page-image flex justify-center items-center">
      {image && <img src={image.single} alt={image.alt} className="self-center" />}
      {!image && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#111" width={100} height={100}>
