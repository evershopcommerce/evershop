...
export default function UseShippingOrAnother({ areaProps, action }) {
  ...
  return (
    <div className="checkout-billing-address-use-shipping">
      <div>
        <div>
          <label>
            <input onChange={(e) => { set$UseShippping(e); }} type="radio" className="uk-radio" checked={billingAddress === false && areaProps.needSelectAddress === false} />
            {' '}
        ...
        <div>
          <label>
            <input onChange={(e) => { areaProps.setNeedSelectAddress(true); }} type="radio" className="uk-radio" checked={billingAddress !== false || areaProps.needSelectAddress === true} />
            {' '}
            Use another address
          </label>
        </div>
