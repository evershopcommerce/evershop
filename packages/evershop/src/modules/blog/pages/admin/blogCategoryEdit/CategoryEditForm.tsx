...
interface BlogCategoryEditFormProps {
  action: string;
  gridUrl: string;
}

export default function BlogCategoryEditForm({
  action,
  gridUrl
  ...
  return (
    ...
    >
      ...
      <FormButtons formId="blogCategoryEditForm" cancelUrl={gridUrl} />
    </Form>
  );
}
...
export const query = `
  query Query {
    action: url(routeId: "updateBlogCategory", params: [{key: "id", value: getContextValue("blogCategoryUuid")}]),
