...
export function Paypal({
  ...
  return (
    <div>
      ...
      <div className='p-2 text-center border rounded mt-1 border-divider'>You will be redirected to PayPal</div>
    </div>
  );
}
...
export default function PaypalMethod({
  ...
  return <div>
    <div className='flex justify-start items-center gap-1'>
      {(!selectedPaymentMethod || selectedPaymentMethod.code !== 'paypal') && <a href="#" onClick={(e) => {
        e.preventDefault();
      ...
      {selectedPaymentMethod && selectedPaymentMethod.code === 'paypal' && <div>
