...
function assign(object, data) {
  if (typeof object !== 'object' || object === null) { throw new Error('`object` must be an object'); }

  if (typeof data !== 'object' || data === null) { throw new Error('`data` must be an object'); }

  Object.keys(data).forEach((key) => {
    if (
      (data[key] && data[key].constructor === Array)
      && (object[key] && object[key].constructor === Array)
    ) {
