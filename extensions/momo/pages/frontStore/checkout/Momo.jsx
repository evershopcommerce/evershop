...
import MomoLogo from '@components/frontStore/momo/MomoLogo';
import { _ } from '@evershop/evershop/src/lib/locale/translate';
import RenderIfTrue from '@components/common/RenderIfTrue';

export function Momo({ createOrderAPI, orderId, orderPlaced }) {
  ...
  return (
    <div>
      ...
      <div className="p-8 text-center border rounded mt-4 border-divider">
        {_('You will be redirected to Momo')}
      </div>
    </div>
  );
}
...
export default function MomoMethod({ createOrderAPI }) {
  ...
  useEffect(() => {
    ...
    if (
      ...
      selectedPaymentMethod.code === 'momo'
    ) {
      placeOrder();
    }
  }, [steps]);
  ...
  return (
    <div>
      <div className="flex justify-start items-center gap-4">
        <RenderIfTrue
          condition={
            !selectedPaymentMethod || selectedPaymentMethod.code !== 'momo'
          }
        >
          <a
            href="#"
...
MomoMethod.propTypes = {
  createOrderAPI: PropTypes.string.isRequired
};

export const layout = {
  areaId: 'checkoutPaymentMethodmomo',
  sortOrder: 10
};

export const query = `
  query Query {
    createOrderAPI: url(routeId: "momoCreateOrder")
  }
`;
