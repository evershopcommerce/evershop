        ...
        middee.middlewares.push(
            {
                ...
                middleware: function (request, response, next) {
                    ...
                    if (middleware.length == 4) {
                        middee.stack[id] = middleware(request, response, middee.stack, next);
                        if (middee.stack[id] instanceof Promise)
                            middee.stack[id].catch(e => {
                                console.log("I catched a rejection. I am not gonna tell anybody")
                            })
                    }
                    else {
