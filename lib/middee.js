...
// Load all core middlewares
// scanForMiddleware(resolve(__dirname, './middlewares')).forEach(m => addMiddleware(m.id, m.middleware, null, m.before || null, m.after || null));
// scanForMiddleware(resolve(__dirname, './middlewares/admin')).forEach(m => addMiddleware(m.id, m.middleware, "admin", m.before || null, m.after || null));
// scanForMiddleware(resolve(__dirname, './middlewares/site')).forEach(m => addMiddleware(m.id, m.middleware, "front", m.before || null, m.after || null));
