                    ...
                    <div className="col-span-1">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="self-center">
                                <a href="#" onClick={(e) => createFolder(e, newFolderRefInput.current.value)} className='text-success hover:underline'>Create</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-3">
                        ...
                        <div className="tool-bar grid grid-cols-3 gap-1 mb-2">
                            ...
                            <label htmlFor={"upload-image"} className='self-center'>
                                <a className='text-interactive hover:underline cursor-pointer'><span>Upload images</span></a>
