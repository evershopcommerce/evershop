...
class TestTestadminaddprodect():
  ...
  def test_testadminaddprodect(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".admin-navigation")))
    self.driver.find_element(By.LINK_TEXT, "New Product").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".main-content-inner")))
